...
const uploadImage = (publicId) => (req, res, next) =>
	{
		//Had an issue with this middleware getting rid of the body generated from isLoggedIn.
		const username = req.body.username
		multer().single('image')(req, res, () => {

			//This ensures that put avatar and articles with image will know the logged in user.
